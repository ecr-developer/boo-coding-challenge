...
public interface AccountAPI {
  ...
  Pagination<AccountListResponse> listAccounts(
  ...
  AccountResponse getById(@PathVariable(name = "id") String id);
  ...
  ResponseEntity<?> updateById(@PathVariable(name = "id") String id, @RequestBody UpdateAccountRequest input);
